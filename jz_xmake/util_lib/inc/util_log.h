...
#define dbg_log(format, ...) mylog(DEBUG, format, ## __VA_ARGS__)
#define info_log(format, ...) mylog(INFO, format, ## __VA_ARGS__)
#define warn_log(format, ...) mylog(WARN, format, ## __VA_ARGS__)
#define error_log(format, ...) mylog(ERROR, format, ## __VA_ARGS__)
